 ...
 */
  ...
  let count;
  let todoList;
  fs.readFile(path.join(__dirname,'/todoCounter.txt'),'utf8',(err, data)=> {putCount(data)});
  fs.readFile(path.join(__dirname,'/todoList.json'),'utf8',(err, data)=> {putTodoList(data)});
  function putCount(data){
    count = data;
  }
  function putTodoList(data){
  ...
  app.post('/todos',(req,res)=>{
    ...
    fs.writeFile(path.join(__dirname,'todoCounter.txt'),String(count),'utf8',(err, data)=>console.log('writing to file for count'));
    fs.writeFile(path.join(__dirname,'todoList.json'),JSON.stringify(todoList),'utf8',(err, data)=>console.log('writing to file for todos'));
